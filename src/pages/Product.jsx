...
import { assets } from '../assets/admin_assets/frontend_assets/assets.js';
    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 '>
          <p>An {productData.name} is a high-quality product designed for durability and performance.</p>
          <p>Crafted with precision, this {productData.name} offers exceptional functionality and style.</p>
        </div>
      </div>
        {/* Related products */}
